<template>
  ...
  >
    <!-- modal -->
    <div class="h-72 bg-white w-2/5 rounded-lg overflow-y-scroll">
      ...
      <div class="p-4 ml-12">
        <textarea
          class="w-full focus:outline-none active:outline-none active:border-none focus:ring-0 focus:ring-dim-100"
          rows="4"
          id=""
          placeholder="What's happening?"
        ></textarea>
        <div class="border"></div>
        <div class="w-full py-2 flex justify-start items-center">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
