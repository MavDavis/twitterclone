  ...
  <div class="w-full">
    <register :logo="true" @closeModal="closeModal">
      ...
      <div class="w-full px-4">
        ...
        <button
            class="w-full xs:w-3/4 border rounded-full text-lg text-bold p-3 mt-10"
            :class="[
$store.state.addedDetails ? 'bg-dim-900 text-white'
                : 'bg-slate-300',
            ]"
            :disabled="
             $store.state.addedDetails ? true : false
            "
          >
       Signup
          </button>
